module Components::ButtonHelper
  def render_button(label = '', text: nil, variant: :default, as: :button, href: nil, data: {}, **options, &block)
    button_classes = 'inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-9 px-3'
